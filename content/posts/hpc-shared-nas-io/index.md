...
코드를 모두 실행하지 않아도 흐름은 이해할 수 있다. 직접 확인하고 싶은 독자를 위해 모든 실습은 [`/blog/code/hpc-shared-nas-io/README.md`](/blog/code/hpc-shared-nas-io/README.md)에 실행 순서대로 모아 두었다. Python 표준 라이브러리만 사용하고, 실제 업무 코드나 운영 데이터는 들어 있지 않다.
...
전체 실행 방법은 [`/blog/code/hpc-shared-nas-io/README.md`](/blog/code/hpc-shared-nas-io/README.md)에 있다.
